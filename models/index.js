...
db.studentmessages = require("./message.model.js")(sequelize_config, Sequelize);
...
db.studentfinances.hasMany(db.studentpayments, { foreignKey: 'finance_id' });
db.studentpayments.belongsTo(db.studentfinances, { foreignKey: 'finance_id' });

db.studentpayments.belongsTo(db.students, {
    foreignKey: `student_id`
});

db.studentmessages.belongsTo(db.students, {
    foreignKey: `student_id`
});
module.exports = db;